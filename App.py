...
class Application:
    ...
    displays = list()
    acc_frames = {}
    services = [ ("Account",0),("Softwares",1),("Storage",2) \
                      ,("Disks",3),("Instances",4) ]
    socket = None
    ...
    def setaccountframe(self):
        ...
        self.msg = Label(self.acc_frames['first'],text="Welcome to BestWorker Cloud Services",fg="#879898",font="Times 16 bold")
        self.msg.grid(row=0,column=0,columnspan=2,padx=10,pady=10)

        self.description = Message(self.acc_frames['first'],text='''BestWorket provides the cloud solutions in the form of SaaS and STaaS''')
    ...
    def gotologin(self):
        ...
        Label(self.acc_frames['login'],text="Welcome to BestWorker Cloud Services",fg="#879898",font="Times 16 bold").grid(row=0,column=0,columnspan=2,padx=10,pady=10)
    ...
    def register(self):
        self.acc_frames['first'].grid_forget()
        Label(self.acc_frames['register'],text="Welcome to BestWorker Cloud Services",fg="#879898",font="Times 16 bold").grid(row=0,column=0,columnspan=2,padx=10,pady=10)
    ...
    def mount(self):
        ...
        self.directory = subprocess.getoutput('cd ; pwd') +  '/' + 'Bestworker'
